...
public class GerenciarProduto extends JFrame {
	...
	static GerenciarProduto gp = new GerenciarProduto();
	...
	public GerenciarProduto() {
		...
		JButton btnCriarCliente = new JButton("Criar Produto");
		...
		JButton btnEditarCliente = new JButton("Editar Produto");
		...
		JButton btnRemoverCliente = new JButton("Listar Produto");
